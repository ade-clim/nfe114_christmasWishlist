 ...
 */
final class Version20200123114700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE deco_liste (id INT AUTO_INCREMENT NOT NULL, wallpapers VARCHAR(255) NOT NULL, border VARCHAR(255) DEFAULT NULL, motif VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE liste (id INT AUTO_INCREMENT NOT NULL, deco_liste_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FCF22AF4B8885280 (deco_liste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
